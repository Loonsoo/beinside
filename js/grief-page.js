...
const GRIEF_DATA = {
  ...
  parent: {
    ...
    actions: [
      { icon: '✍️', text: '떠나신 분에게 편지를 써 보세요. 표현적 글쓰기(Expressive Writing)는 감정을 글로 꺼내면 전전두엽이 활성화되어 감정 조절이 쉬워져요.' },
      { icon: '📸', text: '사진 한 장을 꺼내 보세요. 그때의 이야기를 누군가에게 들려주세요. 기억을 의식적으로 떠올리면 뇌의 보상 회로가 활성화돼 슬프지만 따뜻한 감정도 함께 올라와요.' },
      { icon: '🚶', text: '오늘 10분만 밖에 나가 걸어보세요. 걷기는 세로토닌과 엔돌핀을 분비시켜 마음의 무게를 조금 덜어줘요.' },
      { icon: '🤝', text: '같은 경험을 한 사람을 찾아보세요. 공감받는 경험은 옥시토신을 분비시키고 고립감을 줄여줘요.' }
    ],
    help: [
  ...
  child: {
    ...
    actions: [
      ...
      { icon: '✍️', text: '아이에게 편지를 써 보세요. "보고 싶어", "사랑해" — 감정을 글로 꺼내면 편도체 활성화가 줄어들어 마음이 조금 가라앉아요.' },
      { icon: '🤝', text: '같은 경험을 한 부모 모임을 찾아보세요. 공감받는 경험은 옥시토신을 분비시켜 고립감을 줄여줘요.' },
  ...
  spouse: {
    ...
    actions: [
      ...
      { icon: '🍚', text: '오늘 한 끼만 제대로 먹어보세요. 영양 섭취가 세로토닌 합성의 기반이에요. 배우자가 좋아하던 음식이어도 괜찮아요.' },
      { icon: '📞', text: '오늘 한 사람에게 전화해 보세요. 목소리를 듣는 것만으로도 옥시토신이 분비되어 외로움이 줄어들어요.' },
      { icon: '✍️', text: '함께한 시간 중 가장 좋았던 순간을 적어보세요. 긍정적 기억을 떠올리면 뇌의 보상 회로가 활성화돼 따뜻한 감정이 올라와요.' }
    ],
    help: [
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '무료, 24시간.' },
  ...
  sibling: {
    ...
    actions: [
      { icon: '💬', text: '신뢰하는 사람에게 "나도 많이 슬프다"고 말해 보세요. 감정을 말로 꺼내면 편도체 활성화가 줄어들어요. 부모님 걱정 말고, 내 감정을 먼저 꺼내도 괜찮아요.' },
      { icon: '✍️', text: '형제에게 하지 못한 말을 편지로 써 보세요. 표현적 글쓰기는 전전두엽을 활성화해 감정 조절을 도와줘요.' },
      { icon: '📸', text: '함께 찍은 사진을 하나 골라 핸드폰 배경으로 설정해 보세요. 시각적 기억은 뇌의 보상 회로를 활성화해 따뜻한 위안을 줘요.' }
    ],
    help: [
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '무료, 24시간.' }
  ...
  friend: {
    ...
    actions: [
      { icon: '✍️', text: '친구에게 마지막 편지를 써 보세요. 감정을 글로 꺼내면 전전두엽이 활성화되어 감정 조절이 쉬워져요.' },
      { icon: '📸', text: '함께한 사진을 모아 작은 앨범을 만들어 보세요. 기억을 정리하는 행위가 뇌의 애도 과정을 도와줘요.' },
      { icon: '🤝', text: '친구의 다른 친구들에게 연락해 보세요. 슬픔을 함께 나누면 옥시토신이 분비되어 고립감이 줄어들어요.' },
      { icon: '🕯️', text: '친구가 좋아하던 곳에 가보세요. 장소와 연결된 기억은 뇌의 보상 회로를 활성화해 슬프지만 따뜻한 위안을 줘요.' }
    ],
    help: [
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '무료, 24시간.' }
  ...
  miscarriage: {
    ...
    actions: [
      { icon: '🌼', text: '아이에게 편지를 써 보세요. 감정을 글로 꺼내면 편도체 활성화가 줄어들어 마음이 조금 가라앉아요.' },
      { icon: '🌱', text: '작은 화분을 하나 심어보세요. 돌봄 행동은 옥시토신을 분비시켜 상실감을 부드럽게 달래줘요.' },
      { icon: '💬', text: '같은 경험을 한 사람에게 이야기해 보세요. 공감받는 경험은 뇌의 사회적 보상 회로를 활성화해 고립감을 줄여줘요.' },
  ...
  pet: {
    ...
    actions: [
      { icon: '📸', text: '가장 좋아하는 사진을 골라 액자에 넣어보세요. 시각적 기억은 뇌의 보상 회로를 활성화해 따뜻한 위안을 줘요.' },
      { icon: '✍️', text: '함께한 시간 중 가장 행복했던 순간을 적어보세요. 긍정적 기억을 글로 남기면 애도 과정에서 의미를 찾는 데 도움이 돼요.' },
      { icon: '💬', text: '같은 경험을 한 사람에게 이야기해 보세요. 슬픔을 나누면 옥시토신이 분비되어 고립감이 줄어들어요.' },
      { icon: '🌿', text: '반려동물의 이름으로 작은 화분을 키워보세요. 돌봄 행동은 옥시토신을 분비시켜 상실의 아픔을 부드럽게 달래줘요.' }
    ],
    help: [
