...
const SENIOR_ISOLATION_DATA = {
  ...
  loneliness: {
    ...
    help: [
      ...
      { number: '1393', name: '정신건강복지센터', desc: '전국 어디서나 무료 정신건강 상담. 가까운 센터를 찾아줘요.' }
    ]
  },
  ...
  retirement: {
    ...
    help: [
      ...
      { number: '1393', name: '정신건강복지센터', desc: '전국 무료 정신건강 상담. 가까운 센터 연결.' }
    ]
  },
  ...
  family: {
    ...
    check: {
      ...
      results: {
        ...
        mid: { label: '마음이 많이 힘드실 거예요. 상담을 통해 정리할 수 있어요.', threshold: 2, action: '<a href="tel:1393">1393</a>(정신건강복지센터)에서 무료 상담을 받을 수 있어요.' },
    ...
    actions: [
      ...
      { icon: '🏥', text: '정신건강복지센터(1393)에 상담해 보세요. "자식 문제로 힘들다"고 말하면 돼요. 무료예요.' },
    ...
    help: [
      ...
      { number: '1393', name: '정신건강복지센터', desc: '가족 갈등으로 인한 우울·분노 상담. 무료.' },
