...
const SENIOR_ISOLATION_DATA = {
  ...
  loneliness: {
    ...
    check: {
      ...
      results: {
        high: { label: '혼자 감당하기 어려운 상태일 수 있어요. 전화 한 통이면 돼요.', threshold: 4, action: '<a href="tel:15770199">1577-0199</a>(정신건강위기상담, 무료·24시간)에 편하게 전화해 보세요.' },
    ...
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '무료, 24시간. 외로움, 우울 모두 상담 가능. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '129', name: '정부 복지상담센터', desc: '독거노인 안전 확인 서비스, 복지 제도 통합 안내. "혼자 사는 노인인데요"라고 하면 연결해 줘요.' },
      { number: '1577-0199', name: '정신건강상담전화 (정신건강복지센터 연결)', desc: '전국 어디서나 무료 정신건강 상담. 가까운 센터를 찾아줘요.' }
    ]
  },
  ...
  retirement: {
    ...
    check: {
      ...
      results: {
        high: { label: '혼자 감당하기 어려운 상태일 수 있어요.', threshold: 4, action: '<a href="tel:15770199">1577-0199</a>(정신건강위기상담, 무료·24시간)에 편하게 전화해 보세요.' },
    ...
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '무료, 24시간. 무기력감, 우울 모두 상담 가능.' },
      { number: '129', name: '정부 복지상담센터', desc: '노인 일자리 사업, 사회활동 프로그램 안내.' },
      { number: '1577-0199', name: '정신건강상담전화 (정신건강복지센터 연결)', desc: '전국 무료 정신건강 상담. 가까운 센터 연결.' }
    ]
  },
  ...
  cognitive: {
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '무료, 24시간. 기억 문제로 불안할 때도 전화할 수 있어요.' },
  ...
  family: {
    ...
    check: {
      ...
      results: {
        ...
        mid: { label: '마음이 많이 힘드실 거예요. 상담을 통해 정리할 수 있어요.', threshold: 2, action: '<a href="tel:1577-0199">1577-0199</a>(정신건강상담전화, 정신건강복지센터 연결)에서 무료 상담을 받을 수 있어요.' },
    ...
    actions: [
      ...
      { icon: '🏥', text: '정신건강상담전화(1577-0199)로 전화하면 가까운 정신건강복지센터로 연결돼요. 상담해 보세요. "자식 문제로 힘들다"고 말하면 돼요. 무료예요.' },
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강상담전화 (정신건강복지센터 연결)', desc: '가족 갈등으로 인한 우울·분노 상담. 무료.' },
  ...
  limited: {
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '무료, 24시간. 몸이 아프고 마음도 힘들 때.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 삶이 힘들 때 언제든 전화할 수 있어요.' }
    ]
  },
