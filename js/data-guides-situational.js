...
const EMOTION_GUIDE_DATA = {
  sad: {
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 정신건강 어려움 전반.' }
    ]
  },
  anxious: {
    ...
    check: {
      ...
      results: {
        high: { label: '전문가 상담이 필요한 수준이에요', threshold: 3, action: '<a href="tel:1577-0199">1577-0199</a>(정신건강위기상담, 24시간 · 상담 무료(통화료는 들 수 있어요)) 또는 정신건강복지센터에 연락해 보세요.' },
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간.' }
    ]
  },
  numb: {
    ...
    check: {
      ...
      results: {
        high: { label: '우울증 증상과 비슷해요. 전문가 상담을 권해요.', threshold: 2, action: '정신건강복지센터 또는 <a href="tel:1577-0199">1577-0199</a>(상담 무료(통화료는 들 수 있어요))에 연락해 보세요.' },
  ...
  exhausted: {
    ...
    check: {
      ...
      results: {
        high: { label: '번아웃 또는 우울증 가능성이 있어요. 전문가 상담을 권해요.', threshold: 2, action: '<a href="tel:1577-0199">1577-0199</a>(정신건강위기상담, 24시간 · 상담 무료(통화료는 들 수 있어요))에 연락해 보세요.' },
...
const SLEEP_DATA = {
  ...
  cantfall: {
    ...
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 불면이 심해 극심한 고통을 겪고 있다면.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  },
  ...
  nightmare: {
    ...
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 악몽으로 극심한 고통이 있다면.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  },
  ...
  toomuch: {
    ...
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 과수면과 우울감이 함께 있다면.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  }
};
...
const GRIEF_DATA = {
  ...
  parent: {
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 애도 과정에서 전문 상담이 필요할 때.' },
  ...
  pet: {
    ...
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 반려동물 상실의 슬픔도 상담받을 수 있어요.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  }
};
...
const ELDER_CARE_DATA = {
  ...
  chronic: {
    ...
    check: {
      ...
      results: {
        high: { label: '간병 우울로 발전할 수 있어요. 도움을 받아야 해요.', threshold: 3, action: '정신건강복지센터(1577-0199, 상담 무료(통화료는 들 수 있어요))에서 간병자 전용 상담을 받을 수 있어요.' },
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 간병 우울·소진 시. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  },
  ...
  caregiver: {
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 간병 번아웃 전용 상담도 가능해요. 자세한 내용은 전화 시 확인해 주세요.' },
...
/* ──────────────────────────────────────────────────────────
   5. 노인 정서 돌봄 가이드 데이터 (SENIOR_ISOLATION_DATA)
   ────────────────────────────────────────────────────────── */

const SENIOR_ISOLATION_DATA = {
  intro: {
    title: '사람이 그리울 때',
    sub: '혼자 감당하지 않아도 돼요. 연결될 수 있어요.',
    stat: { pct: '약 190만', label: '65세 이상 독거 가구 수. 우울증 치료를 받으면 70% 이상이 호전돼요. (통계청 2024, 국립정신건강센터)' }
  },

  disclaimer: '이 가이드는 정보 제공 목적이며, 전문 상담을 대체하지 않습니다. 지금 힘든 상황이라면 아래 번호로 바로 연락하실 수 있어요.',

  situations: [
    { id: 'loneliness', icon: '🏠', label: '혼자 지내는 시간이 길어졌을 때', sub: '사별, 독거, 자녀 독립 후 찾아오는 고립감' },
    { id: 'retirement', icon: '👔', label: '은퇴 후 갈 곳이 없을 때', sub: '직장이 전부였는데, 이제 뭘 해야 할지 모르겠을 때' },
    { id: 'cognitive', icon: '🧠', label: '기억이 예전 같지 않을 때', sub: '깜빡하는 일이 잦아지고, 그게 불안할 때' },
    { id: 'family', icon: '💔', label: '가족에게 상처받았을 때', sub: '자녀가 재산만 보거나, 사람으로 대해주지 않을 때' },
    { id: 'limited', icon: '🦽', label: '몸이 아파서 나가기 어려울 때', sub: '거동이 불편하고, 바깥세상과 점점 멀어질 때' }
  ],

  /* ── 1. 혼자 지내는 시간이 길어졌을 때 ── */
  loneliness: {
    recognition: '배우자를 떠나보낸 뒤, 자녀가 독립한 뒤, 아프고 나서 — 어느 순간 하루 종일 아무하고도 이야기하지 않는 날이 많아졌을 거예요. 외로움은 나약한 게 아니에요. 연결이 필요하다는 몸과 마음의 신호예요.',
    check: {
      id: 'ct_senior_lonely',
      title: '요즘 이런 적 있으세요?',
      questions: [
        '일주일 동안 다른 사람과 직접 만나서 이야기한 적이 거의 없다',
        '전화나 카카오톡으로 안부를 주고받는 사람이 떠오르지 않는다',
        '하루 종일 TV만 보거나, 아무것도 하지 않는 날이 많다',
        '밖에 나가는 일이 일주일에 1번 이하다',
        '가족에게 미안한 마음이 자주 든다'
      ],
      results: {
        high: { label: '혼자 감당하기 어려운 상태일 수 있어요. 전화 한 통이면 돼요.', threshold: 4, action: '<a href="tel:15770199">1577-0199</a>(정신건강위기상담, 24시간 · 상담 무료(통화료는 들 수 있어요))에 편하게 전화해 보세요.' },
        mid: { label: '고립감이 쌓이고 있어요. 작은 연결부터 시작해 볼 수 있어요.', threshold: 2, action: '아래 행동 가이드를 한 가지만 시도해 보세요.' },
        low: { label: '지금 느끼는 감정을 알아차린 것 자체가 중요해요.', threshold: 0 }
      }
    },
    psychology: '사회적 고립이 지속되면 뇌의 위협 감지 시스템이 과민해져요. 새로운 관계를 시도하는 것 자체가 부담으로 느껴지는 건 의지가 약해서가 아니라, 뇌가 그렇게 반응하는 거예요. 하지만 아주 작은 연결 하나가 이 순환을 바꿀 수 있어요.',
    actions: [
      { icon: '📞', text: '아는 사람에게 전화 한 통 해보세요. "잘 지내?" 한 마디면 충분해요. 먼저 연락하는 게 어색해도, 받는 사람은 반가워해요.' },
      { icon: '🚶', text: '집 근처 10분만 걸어보세요. 매일 아니어도 돼요. 일주일에 2~3번이면 충분해요.' },
      { icon: '🏛️', text: '주민센터나 보건소에 전화해 보세요. "혼자 사는데, 받을 수 있는 서비스가 있나요?" 이 한 마디면 돼요.' },
      { icon: '👥', text: '경로당이나 복지관 프로그램을 알아보세요. 안 맞으면 안 가도 돼요. 한번 가보는 것과 안 가보는 것은 달라요.' },
      { icon: '🌱', text: '작은 역할 하나를 맡아보세요. 화분 돌보기, 동네 고양이 밥 주기 — "내가 하는 일"이 있으면 하루가 달라져요.' }
    ],
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 외로움, 우울 모두 상담 가능. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '129', name: '정부 복지상담센터', desc: '독거노인 안전 확인 서비스, 복지 제도 통합 안내. "혼자 사는 노인인데요"라고 하면 연결해 줘요.' },
      { number: '1577-0199', name: '정신건강상담전화 (정신건강복지센터 연결)', desc: '전국 어디서나. 상담 무료(통화료는 들 수 있어요). 가까운 센터를 찾아줘요.' }
    ]
  },

  /* ── 2. 은퇴 후 갈 곳이 없을 때 ── */
  retirement: {
    recognition: '수십 년간 출근하던 곳이 사라지면, "나는 누구지?"라는 질문이 찾아와요. 동료와의 연락이 끊기고, 하루가 텅 비어버린 느낌 — 이건 나약한 게 아니라, 삶의 큰 전환 앞에서 누구나 겪을 수 있는 일이에요.',
    check: {
      id: 'ct_senior_retire',
      title: '요즘 이런 적 있으세요?',
      questions: [
        '하루 종일 할 일이 없다고 느낀다',
        '예전 직장 동료들과 연락이 거의 끊겼다',
        '집에서 가족과도 대화가 줄었다',
        '술을 마시는 횟수나 양이 늘었다',
        '나는 이제 쓸모없는 사람이라는 생각이 든다'
      ],
      results: {
        high: { label: '혼자 감당하기 어려운 상태일 수 있어요.', threshold: 4, action: '<a href="tel:15770199">1577-0199</a>(정신건강위기상담, 24시간 · 상담 무료(통화료는 들 수 있어요))에 편하게 전화해 보세요.' },
        mid: { label: '전환기의 어려움이 쌓이고 있어요. 작은 변화부터 시작해 볼 수 있어요.', threshold: 2, action: '아래 행동 가이드를 한 가지만 시도해 보세요.' },
        low: { label: '전환기를 인식하고 계시네요. 그 자체가 중요한 시작이에요.', threshold: 0 }
      }
    },
    psychology: '직장은 단순한 일터가 아니라 사회적 정체성, 일과 구조, 인간관계를 한꺼번에 제공하던 곳이에요. 은퇴 후 허전함은 "일"을 잃은 것이 아니라 "나"를 잃은 것처럼 느껴질 수 있어요. 하지만 직장 밖에서도 의미 있는 역할을 찾을 수 있어요.',
    actions: [
      { icon: '🔧', text: '관심 있었지만 못 했던 것 하나를 시작해 보세요. 텃밭, 낚시, 서예, 산책 모임 — 뭐든 괜찮아요.' },
      { icon: '🤝', text: '노인복지관이나 주민센터의 프로그램을 알아보세요. "아는 것을 가르치는" 봉사 활동도 있어요.' },
      { icon: '🍽️', text: '배우자가 있다면, 함께 하는 구체적 활동 한 가지를 정해보세요. 장보기, 산책 — 대화보다 함께하는 시간이 먼저예요.' },
      { icon: '📱', text: '옛 동료 한 명에게 연락해 보세요. "밥 한번 먹자"가 아니라 "요즘 어때?"로 시작하면 부담이 없어요.' },
      { icon: '🏃', text: '하루에 한 가지, 밖에 나갈 이유를 만들어 보세요. 우유 사기, 공원 한 바퀴 — 작은 외출이 하루를 바꿔줘요.' }
    ],
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 무기력감, 우울 모두 상담 가능.' },
      { number: '129', name: '정부 복지상담센터', desc: '노인 일자리 사업, 사회활동 프로그램 안내.' },
      { number: '1577-0199', name: '정신건강상담전화 (정신건강복지센터 연결)', desc: '전국 어디서나. 상담 무료(통화료는 들 수 있어요). 가까운 센터 연결.' }
    ]
  },

  /* ── 3. 기억이 예전 같지 않을 때 ── */
  cognitive: {
    recognition: '약속을 잊거나, 물건을 둔 곳이 생각나지 않거나, 말이 바로 안 나올 때 — 불안해지는 건 당연해요. 검사받는 게 무서울 수 있어요. 하지만 일찍 알수록 할 수 있는 게 더 많아요.',
    check: {
      id: 'ct_senior_cognitive',
      title: '요즘 이런 적 있으세요?',
      questions: [
        '같은 말을 반복하거나, 방금 한 이야기를 잊는다',
        '익숙한 길인데 헷갈리거나 물건 둔 곳을 자주 잊는다',
        '요리, 청소 같은 익숙한 일의 순서가 혼동된다',
        '기억 문제가 걱정되지만 병원에 가기가 망설여진다'
      ],
      results: {
        high: { label: '기억 걱정이 크시군요. 치매안심센터에서 무료로 상담받을 수 있어요.', threshold: 3, action: '<a href="tel:18999988">1899-9988</a>(중앙치매센터)에서 가까운 치매안심센터를 안내받을 수 있어요.' },
        mid: { label: '걱정이 되실 수 있어요. 기억 문제는 우울증에서 오는 경우도 있어요.', threshold: 2, action: '보건소에서 65세 이상 무료 인지 검진을 받을 수 있어요.' },
        low: { label: '정상적인 노화에서도 깜빡하는 일은 있어요. 걱정이 계속되면 검진을 받아보세요.', threshold: 0 }
      }
    },
    psychology: '기억력 변화를 느끼면 "혹시 치매?"라는 생각에 무서워지는 건 자연스러운 거예요. 하지만 기억 문제의 상당수는 우울증, 수면 부족, 약물 부작용에서 오기도 해요. 검사는 "치매 선고"가 아니라 "원인을 찾는 과정"이에요. 원인을 알면 대처할 수 있어요.',
    actions: [
      { icon: '🏥', text: '가까운 치매안심센터(1899-9988)에 전화해 보세요. "기억이 걱정돼서요"라고 하면 돼요. 무료 검진을 안내해 줘요.' },
      { icon: '📝', text: '메모 습관을 만들어 보세요. 달력에 약속 적기, 약 먹을 시간 알람 설정 — 기억을 도와주는 도구를 쓰는 건 부끄러운 일이 아니에요.' },
      { icon: '🧩', text: '새로운 것을 배워보세요. 스마트폰 사용법, 간단한 운동, 그림 그리기 — 뇌에 새로운 자극을 주는 게 도움이 돼요.' },
      { icon: '🚶', text: '규칙적인 걷기가 뇌 건강에 좋아요. 일주일에 3번, 30분 정도면 충분해요.' }
    ],
    help: [
      { number: '1899-9988', name: '중앙치매센터', desc: '치매 무료 검진, 상담, 배회감지기 신청. 기억이 걱정될 때.' },
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 기억 문제로 불안할 때도 전화할 수 있어요.' },
      { number: '129', name: '정부 복지상담센터', desc: '치매 관련 복지 서비스 통합 안내.' }
    ]
  },

  /* ── 4. 가족에게 상처받았을 때 ── */
  family: {
    recognition: '재산 이야기만 꺼내는 자녀, 안부 없이 오는 연락, 내 의사가 무시되는 상황 — 이런 일이 반복되면 분노보다 허탈함이 먼저 와요. "내가 뭘 위해 살았나" 싶은 마음이 드는 건 당연해요.',
    check: {
      id: 'ct_senior_family',
      title: '해당하는 것이 있나요?',
      questions: [
        '자녀가 연락할 때 돈이나 재산 이야기가 대부분이다',
        '내 의사와 상관없이 재산이나 거주지가 결정되고 있다',
        '자녀에게 서운함을 말하면 무시당하거나 "또 시작이다" 취급을 받는다',
        '가족이 있는데 오히려 더 외롭다'
      ],
      results: {
        high: { label: '혼자 삼키기엔 무거운 상황이에요. 도움받을 수 있어요.', threshold: 3, action: '<a href="tel:15771389">1577-1389</a>(노인보호전문기관)에서 상담할 수 있어요. 처벌이 아니라 보호를 위한 곳이에요.' },
        mid: { label: '마음이 많이 힘드실 거예요. 상담을 통해 정리할 수 있어요.', threshold: 2, action: '<a href="tel:1577-0199">1577-0199</a>(정신건강상담전화, 정신건강복지센터 연결)에서 상담을 받을 수 있어요. 상담 무료(통화료는 들 수 있어요).' },
        low: { label: '서운한 마음이 드는 건 자연스러운 거예요.', threshold: 0 }
      }
    },
    psychology: '자녀에게 도구처럼 취급당하는 경험은 단순한 서운함을 넘어, 존엄이 훼손되는 일이에요. "내가 잘못 키운 건가"라는 자책이 들 수 있지만, 성인 자녀의 선택은 그 사람의 몫이에요. 당신이 수십 년 키우고 돌본 사실은 사라지지 않아요.',
    mindset: [
      { title: '자녀의 행동이 당신의 가치를 결정하지 않아요', text: '자식을 잘못 키워서가 아니에요. 당신이 살아온 시간과 경험은 그대로 가치가 있어요.' },
      { title: '"효도받을 권리"를 내려놓는 것과 "존중받을 권리"를 포기하는 것은 달라요', text: '자녀에게 기대를 내려놓는 것은 현명한 자기보호일 수 있어요. 하지만 사람으로서 존중받는 것은 포기할 필요 없어요.' },
      { title: '화가 나는 건 자연스러운 거예요', text: '"자식한테 화내면 안 되지" 하고 참을수록 몸과 마음이 아파요. 화가 나는 건 당신이 아직 자신을 지키고 있다는 뜻이에요.' },
      { title: '가족 말고도 연결될 수 있어요', text: '피가 안 섞여도 진심으로 대해주는 사람이 있어요. 그 연결을 찾는 게 지금 가장 중요해요.' }
    ],
    legal: [
      { title: '본인 동의 없는 재산 처분은 법으로 보호받을 수 있어요', text: '노인복지법에 따라 의사에 반하여 재산을 빼앗는 행위는 금지되어 있어요. 법률구조공단(132)에서 무료 상담을 받을 수 있어요.' },
      { title: '증여한 재산도 조건 불이행 시 취소할 수 있어요', text: '부양을 조건으로 증여했는데 부양하지 않는 경우, 증여를 취소할 수 있는 법적 근거가 있어요 (민법 제556조).' },
      { title: '경제적 학대도 학대예요', text: '통장·인감 강제 관리, 연금 가로채기, 명의 이전 강요 — 이런 상황은 노인보호전문기관(1577-1389)에 상담할 수 있어요.' }
    ],
    actions: [
      { icon: '📝', text: '서운한 마음을 종이에 써보세요. 머릿속에만 두면 계속 커져요.' },
      { icon: '🛡️', text: '자녀와의 대화에서 재산 이야기가 나오면 "그 이야기는 다음에 하자"고 경계를 정해도 돼요.' },
      { icon: '⚖️', text: '대한법률구조공단(132)에 전화해 보세요. 재산 문제는 감정이 아니라 법으로 지켜야 해요. 무료예요.' },
      { icon: '🏥', text: '정신건강상담전화(1577-0199)로 전화하면 가까운 정신건강복지센터로 연결돼요. 상담해 보세요. "자식 문제로 힘들다"고 말하면 돼요. 상담 무료(통화료는 들 수 있어요).' },
      { icon: '👥', text: '가족 외에 정기적으로 만나는 사람을 만들어 보세요. 복지관, 경로당, 종교 모임 어디든.' }
    ],
    help: [
      { number: '1577-1389', name: '노인보호전문기관', desc: '경제적 학대 상담·신고. 처벌이 아니라 보호를 위한 곳. 24시간.' },
      { number: '132', name: '대한법률구조공단', desc: '재산·상속·부양 문제 무료 법률상담. 65세 이상 우선 지원.' },
      { number: '1577-0199', name: '정신건강상담전화 (정신건강복지센터 연결)', desc: '가족 갈등으로 인한 우울·분노 상담. 상담 무료(통화료는 들 수 있어요).' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 삶이 힘들 때 언제든 전화할 수 있어요.' }
    ]
  },

  /* ── 5. 몸이 아파서 나가기 어려울 때 ── */
  limited: {
    recognition: '관절이 아프거나, 거동이 불편하거나, 시력이 나빠져서 밖에 나가기 어려워지면 — 세상과 점점 멀어지는 느낌이 들어요. 몸이 아프면 마음도 함께 가라앉는 건 자연스러운 거예요.',
    check: {
      id: 'ct_senior_limited',
      title: '요즘 이런 적 있으세요?',
      questions: [
        '몸이 아파서 외출이 일주일에 1번 이하다',
        '아파도 병원에 가기가 어렵다',
        '집에서 하루 종일 혼자 있는 날이 대부분이다',
        '도움이 필요한데 누구에게 말하기 어렵다'
      ],
      results: {
        high: { label: '혼자 감당하기 어려운 상황이에요. 집으로 찾아오는 서비스가 있어요.', threshold: 3, action: '<a href="tel:129">129</a>(정부 복지상담센터)에 전화하면 방문 돌봄을 안내받을 수 있어요.' },
        mid: { label: '도움받을 수 있는 서비스가 있어요. 아래에서 확인해 보세요.', threshold: 2, action: '주민센터에 전화해서 노인맞춤돌봄서비스를 문의해 보세요.' },
        low: { label: '지금 상태를 살펴보고 계시네요. 필요할 때 연락할 수 있는 곳을 알아두세요.', threshold: 0 }
      }
    },
    psychology: '몸이 아프면 뇌도 영향을 받아요. 통증이 지속되면 기분을 조절하는 뇌 물질의 균형이 깨지기 쉬워요. "몸이 아프니까 우울한 게 당연하지"라고 넘기지 않는 게 중요해요. 몸 돌봄과 마음 돌봄은 따로가 아니에요.',
    actions: [
      { icon: '📞', text: '독거노인 안전 확인 서비스를 신청하세요. 매일 전화가 와요. 사람 목소리를 듣는 것만으로 달라져요. 129로 전화하세요.' },
      { icon: '🏠', text: '노인맞춤돌봄서비스를 알아보세요. 집으로 사람이 와요. 장기요양등급이 없어도 이용 가능한 서비스가 있어요.' },
      { icon: '📻', text: 'TV 대신 라디오를 틀어보세요. 사람 목소리가 함께하는 느낌을 줘요.' },
      { icon: '🪟', text: '하루에 한 번, 창문을 열어보세요. 바깥 공기를 마시는 것만으로 기분이 조금 달라져요.' },
      { icon: '💊', text: '약을 제때 드시고 있는지 확인해 보세요. 약을 빠뜨리면 몸도 마음도 더 힘들어질 수 있어요.' }
    ],
    help: [
      { number: '129', name: '정부 복지상담센터', desc: '방문 돌봄, 독거노인 안전 확인, 복지 서비스 통합 안내.' },
      { number: '1577-1000', name: '국민건강보험공단', desc: '장기요양등급 신청, 방문요양, 주간보호 안내.' },
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 몸이 아프고 마음도 힘들 때.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 삶이 힘들 때 언제든 전화할 수 있어요.' }
    ]
  },
  ...
  forFamily: {
    title: '부모님이 혼자 계신다면',
    items: [
      { icon: '📞', title: '정기적으로 전화하기', text: '주 2~3회, 짧아도 돼요. "밥 먹었어?"보다 "오늘 뭐 했어?"가 대화를 열어요.' },
      { icon: '🏠', title: '안전 확인 서비스 신청해 드리기', text: '129에 전화해서 부모님 주소로 신청하면 매일 안부를 확인해 줘요.' },
      { icon: '🚶', title: '방문 시 동네 자원 연결해 드리기', text: '복지관, 경로당, 보건소 위치를 알려드리고, 가능하면 첫 방문을 함께.' },
      { icon: '👀', title: '"괜찮다"는 말을 액면 그대로 믿지 않기', text: '노인 세대는 힘들어도 "괜찮다"고 말하는 경우가 많아요. 표정, 집 상태, 식사 여부를 살펴보세요.' },
      { icon: '🩺', title: '보건소 정신건강 검진 안내하기', text: '65세 이상은 무료 검진이 가능해요. "건강검진인데 같이 가자"고 말씀해 보세요.' }
    ]
  }
};
