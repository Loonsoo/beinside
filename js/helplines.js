/* ═══════════════════════════════════════════════════════════
   ...
   확인일: 2026-09-25
   - 109: 자살예방상담전화 (2024.1.1 통합) — 보건복지부
     sms:109 문자 상담: 2차 출처(지자체·언론)만 확인, 129.go.kr 원문 미열람.
     확인 전까지 문자 버튼 옆에 마들랜을 보이게 둔다 (reports/2026-09-copy-review.md §8-7)
   - 마들랜: 109 SNS 상담 카카오톡 채널 — 한국생명존중희망재단 운영
   - 1577-0199: 정신건강위기상담전화 (지역 정신건강복지센터 연결, 전국대표번호라 통화료 발생 가능)
   - 1644-6621: 가족상담전화 (365일 24시간, 전국대표번호라 통화료 발생 가능)
═══════════════════════════════════════════════════════════ */
...
const HELPLINES = {
  ...
  mental:    { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요) · 24시간 · 지역 정신건강복지센터로 연결' },
  women:     { number: '1366',      name: '여성긴급전화',      desc: '가정폭력·성폭력 · 24시간' },
  youth:     { number: '1388',      name: '청소년상담전화',    desc: '무료 · 24시간' },
  family:    { number: '1644-6621', name: '가족상담전화',      desc: '365일 24시간 · 양육·가족 고민 · 통화료는 들 수 있어요' },
};
