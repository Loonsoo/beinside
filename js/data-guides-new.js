...
const POSTPARTUM_DATA = {
  ...
  check: {
    ...
    emergencyIndex: 6,
    emergencyMsg: '<strong>지금 바로 도움을 받을 수 있어요.</strong><br>이런 생각이 드는 건 혼자 버티기 어렵다는 신호예요. 당신 탓이 아니에요.<br>나나 아기가 지금 위험하다면 <a href="tel:119">119</a>에 전화해 주세요.',
    results: {
      ...
      low:  { label: '지금 체크한 신호는 적어요', threshold: 0, action: '마음이 달라지면 언제든 다시 확인해 보세요.' }
    }
  },
  actions: {
    immediate: [
