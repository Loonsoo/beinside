...
const ADHD_DATA = {
  ...
  help: [
    { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 정신건강 관련 상담. 자세한 내용은 전화 시 확인해 주세요.' },
    { number: '1577-0199', name: '정신건강상담전화 (정신건강복지센터 연결)', desc: '전국 어디서나. 정신건강 상담·치료 연계. 자세한 내용은 전화 시 확인해 주세요.' },
...
const ADDICTION_DATA = {
  ...
  help: [
    ...
    { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 중독과 동반되는 우울·불안 상담. 자세한 내용은 전화 시 확인해 주세요.' },
...
const FINANCE_DATA = {
  ...
  help: [
    ...
    { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 금융 스트레스로 인한 우울·불안 상담. 자세한 내용은 전화 시 확인해 주세요.' },
    { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 극단적 생각이 들 때. 자세한 내용은 전화 시 확인해 주세요.' }
  ]
};
...
const BURNOUT_DATA = {
  ...
  help: [
    { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 번아웃이 심해졌을 때 언제든. 자세한 내용은 전화 시 확인해 주세요.' },
    { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 극단적 생각이 들 때. 자세한 내용은 전화 시 확인해 주세요.' }
  ]
};
...
const TRANSITION_DATA = {
  ...
  jobless: {
    ...
    check: {
      ...
      emergencyMsg: '지금 당장 이야기를 들어줄 사람이 있어요. <a href="tel:109" style="color:inherit;font-weight:700">📞 109</a>(자살예방상담, 무료·24시간). 자세한 내용은 전화 시 확인해 주세요.',
      results: {
        high: { label: '지금 전문적 지원이 필요해요', threshold: 2, action: '<a href="tel:109">109</a>(자살예방상담, 무료·24시간) 또는 <a href="tel:1577-0199">1577-0199</a>(상담 무료(통화료는 들 수 있어요))에 연락해 보세요.' },
    ...
    help: [
      ...
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 실직 후 심리적 어려움이 클 때. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  },
  failure: {
    ...
    help: [
      ...
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  },
  direction: {
    ...
    help: [
      { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 무력감이 클 때. 자세한 내용은 전화 시 확인해 주세요.' },
      { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 자세한 내용은 전화 시 확인해 주세요.' }
    ]
  },
  move: {
...
const POSTPARTUM_DATA = {
  ...
  science: {
    ...
    distinctions: [
      { name: '베이비 블루스', desc: '출산 후 3~5일에 시작, 2주 이내 자연스럽게 나아져요. 많은 산모(절반 이상)가 경험해요.', icon: '🌧️' },
      { name: '산후우울증', desc: '2주 이상 지속되는 깊은 우울·무기력. 일상생활이 어려워요. 전문 도움이 필요해요.', icon: '🌑' },
      { name: '산후 정신병', desc: '환각·망상·심한 혼란, 들뜨고 잠이 필요 없다고 느낌. 드물지만(출산 1,000명 중 1~2명) 바로 응급 치료가 필요해요.', icon: '🚨' }
    ]
  },
  check: {
    id: 'ct_postpartum',
    title: '산후 마음 신호 확인',
    sub: '지난 7일을 떠올리며 해당하는 것에 체크해 주세요. 진단이 아니라, 도움을 받을 때가 됐는지 알아보는 확인이에요. 체크한 내용은 저장하거나 보내지 않아요.',
    questions: [
      '이유 없이 슬프거나 눈물이 났다',
      '아무것도 하고 싶지 않고 무기력했다',
      '아기에 대한 감정이 잘 느껴지지 않았다',
      '이유 없이 불안하거나 겁이 나고, 가슴이 두근거렸다',
      '잠들기 어렵거나 아기가 자도 잠이 오지 않았다',
      '식욕이 크게 변했다 (전혀 없거나 과식)',
      '나를 해치고 싶거나 사라지고 싶다는 생각, 또는 아기를 해칠 것 같은 생각이 들었다'
    ],
    emergencyIndex: 6,
    emergencyMsg: '<strong>지금 <a class="tel-inline" href="tel:109">109</a>에 전화나 문자로 이야기해 주세요.</strong> 무료이고 24시간 받아요.<br>방법까지 생각했거나, 나나 아기가 지금 위험하다면 <a class="tel-inline" href="tel:119">119</a>에 전화해 주세요.<br>이런 생각이 드는 건 혼자 버티기 어렵다는 신호예요. 누구의 탓도 아니에요.<br>아기가 다치는 장면이 원하지 않는데 자꾸 떠올라 무서운 거라면, 산후에 적지 않게 겪고 그 생각대로 행동하는 것과는 달라요. 그 생각도 그대로 말해도 돼요.',
    results: {
      high: { label: '오늘 연락해 볼 때예요', threshold: 4, action: '<a class="tel-inline" href="tel:15770199">1577-0199</a>에 전화하면 지역 정신건강복지센터로 연결돼요(24시간, 상담 무료(통화료는 들 수 있어요)). 보건소나 산부인과에서도 산후우울 검사를 받을 수 있어요.' },
      mid:  { label: '지켜볼 신호가 있어요', threshold: 2, action: '아래 행동 가이드를 시도해 보세요. 2주 넘게 이어지거나 일상이 어려워지면 보건소나 산부인과에 산후우울 검사를 문의해 보세요.' },
      low:  { label: '지금 체크한 신호는 적어요', threshold: 0, action: '마음이 달라지면 언제든 다시 확인해 보세요. 체크한 개수와 상관없이 힘들다면 <a class="tel-inline" href="tel:15770199">1577-0199</a>(24시간 · 상담 무료(통화료는 들 수 있어요))나 보건소에 이야기해도 돼요.' }
    }
  },
  actions: {
    immediate: [
      { icon: '🛌', text: '누군가 한 번이라도 밤 수유를 맡아 줄 수 있다면, 그날은 길게 이어 자 보세요. 수면 부족은 우울을 더 무겁게 해요.' },
    ...
    week: [
      ...
      { icon: '🚶', text: '가벼운 산책을 시작해 보세요. 10~15분이면 충분해요. 가벼운 우울에는 운동이 도움이 된다는 근거가 있어요.' },
      { icon: '📓', text: '하루 3줄 감정 일기를 써보세요. "오늘 힘들었던 것 1개, 감사한 것 1개, 내일 할 수 있는 것 1개". 인지행동치료에서도 쓰는 방법이에요.' }
    ],
    longterm: [
      { icon: '🏥', text: '보건소 정신건강 서비스는 무료예요 — 산후우울증 선별 검사(EPDS)를 받아볼 수 있어요. 정신건강의학과 진료도 산후우울을 다루는 일반적인 방법이에요.' },
      { icon: '💊', text: '산후우울증은 치료로 나아질 수 있어요. 약물치료와 심리치료를 함께 쓰기도 하고, 수유 중에도 안전한 약이 있으니 의사와 상의해 보세요.' },
      { icon: '👥', text: '산후우울증 자조 모임이나 온라인 커뮤니티에 참여해 보세요. 같은 경험을 나누는 것만으로도 고립감이 줄어들어요.' }
    ]
  },
  riskFactors: {
    title: '산후우울이 생기기 쉬운 경우',
    items: [
      '이전에 우울증·불안장애를 경험한 적이 있는 경우',
      '가족 중 우울증 병력이 있는 경우',
      '사회적 지지가 부족한 경우 (도와줄 사람이 없을 때)',
      '임신·출산 중 합병증을 경험한 경우',
      '원치 않은 임신이었던 경우',
      '경제적 어려움이 있는 경우'
    ]
  ...
  help: [
    { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 죽고 싶거나 사라지고 싶은 생각이 들 때. 문자도 돼요.' },
    { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 산후우울증 포함 정신건강 전반 상담.' },
    { number: '1366', name: '여성긴급전화', desc: '무료, 24시간. 가정폭력·성폭력 피해 상담과 긴급 보호 연계.' }
  ]
};
...
const MENOPAUSE_DATA = {
  ...
  help: [
    { number: '1577-0199', name: '정신건강위기상담전화', desc: '상담 무료(통화료는 들 수 있어요), 24시간. 갱년기 우울 포함 정신건강 전반 상담.' },
    { number: '109', name: '자살예방상담전화', desc: '무료, 24시간. 극단적 생각이 들 때. 자세한 내용은 전화 시 확인해 주세요.' },
