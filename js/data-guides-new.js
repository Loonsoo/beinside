...
const POSTPARTUM_DATA = {
  ...
  check: {
    id: 'ct_postpartum',
    title: '산후 마음 신호 확인',
    sub: '지난 7일을 떠올리며 해당하는 것에 체크해 주세요. 진단이 아니라, 도움을 받을 때가 됐는지 알아보는 확인이에요.',
    questions: [
      '이유 없이 슬프거나 눈물이 났다',
      '아무것도 하고 싶지 않고 무기력했다',
      ...
      '나를 해치거나 사라지고 싶다는 생각, 또는 아기를 해칠 것 같은 생각이 들었다'
    ],
    emergencyIndex: 6,
    emergencyMsg: '<strong>지금 바로 도움을 받을 수 있어요.</strong><br>이런 생각이 드는 건 혼자 버티기 어렵다는 신호예요. 당신 탓이 아니에요. 원하지 않는데 떠오르는 생각이라면, 산후에 흔히 생기고 행동과는 달라요. 그래도 혼자 두지 말고 오늘 이야기해 주세요.<br>나나 아기가 지금 위험하다면 <a href="tel:119">119</a>에 전화해 주세요.',
    results: {
      high: { label: '혼자 감당하기 어려운 상태일 수 있어요', threshold: 4, action: '오늘 연락해 보세요. 1577-0199에 전화하면 가까운 정신건강복지센터로 연결되고, 보건소나 산부인과에서도 산후우울 검사를 받을 수 있어요.' },
      mid:  { label: '지켜볼 신호가 있어요', threshold: 2, action: '아래 행동 가이드를 시도해 보세요. 2주 넘게 이어지거나 일상이 어려워지면 보건소나 산부인과에 산후우울 검사를 문의해 보세요.' },
      low:  { label: '지금 체크한 신호는 적어요', threshold: 0, action: '마음이 달라지면 언제든 다시 확인해 보세요. 체크한 개수와 상관없이 힘들다면 1577-0199나 보건소에 이야기해도 돼요.' }
    }
  },
  actions: {
    immediate: [
      { icon: '🛌', text: '수면을 최우선으로 — 누군가에게 도움을 받아 최소 4시간 연속 수면을 확보해 보세요. 수면 부족은 우울을 악화시키는 요인이에요.' },
