...
const EMOTION_GUIDE_DATA = {
  sad: {
    ...
    actions: [
      { icon: '🌬️', text: '지금 있는 자리에서 깊게 숨 3번 쉬기 (5초 흡입 — 5초 내쉬기). 느린 호흡이 부교감신경을 활성화해 마음을 가라앉혀줘요.' },
      { icon: '🚪', text: '창문 열거나 밖에 10분 나가기. 환경을 바꾸면 뇌의 주의 시스템이 리셋돼요.' },
      { icon: '💬', text: '신뢰하는 사람 1명에게 "나 좀 힘들어"라고 문자 보내기. 말하는 것만으로도 뇌의 사회적 보상 회로가 활성화돼요.' }
    ],
    help: [
  ...
  exhausted: {
    ...
    actions: [
      { icon: '🛌', text: '오늘 할 일 목록에서 하나를 지우세요. 결정을 줄이면 전전두엽의 부담이 줄어들어요.' },
  ...
  lonely: {
    ...
    actions: [
      { icon: '💌', text: '오래된 친구에게 문자 한 통 보내기. "잘 지내?"라고만 해도 충분해요. 연결 행동은 옥시토신을 분비시켜 외로움을 줄여줘요.' },
      { icon: '☕', text: '카페나 도서관처럼 사람이 있는 곳에 가서 1~2시간 있어보기. 같은 공간에 있는 것만으로도 뇌는 사회적 안전감을 느껴요.' },
      { icon: '📞', text: '말이 하고 싶다면 <a href="tel:109">109</a>에 전화해도 돼요. 상담사가 들어줘요. 목소리를 듣는 것만으로도 옥시토신이 분비돼요.' }
    ],
    help: [
