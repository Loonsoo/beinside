...
**영감의 원천**: Calm App (Calm Technology)

### 3가지 디자인 원칙

**1. Calm Relief (고요한 안심) — Calm App 철학**
...
- 충분한 여백으로 사용자가 읽은 내용을 소화할 시간을 준다
- 한 화면에 하나의 핵심 메시지만 전달한다

**2. Warm Humanity (따뜻한 온기)**
- 지나치게 매끈한 UI보다 "사람이 있는 느낌"의 온기를 추구한다
- 사용자의 불완전한 입력(짧은 답변, 중도 이탈)을 자연스럽게 수용하는 흐름
- Gowun Batang 서체의 따뜻한 질감이 이 원칙을 체현한다

**3. Safety (안전) — Crisis UX**
